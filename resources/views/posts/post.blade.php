                 ...
                 <div class="row">
                    <form class="form-horizontal" method="POST" action="{{ url('/addPost') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('post_title') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="post_title" type="text" class="form-control" name="post_title" value="{{ old('name') }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('post_body') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="post_body"  rows="8" class="form-control" name="post_body" value="{{ old('email') }}" required>
                                </textarea>
